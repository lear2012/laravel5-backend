	...
	<div class="home has-header">
		...
		<section class="routes">
			...
			<div class="numbers">
				...
				<p>已有<span class="thumbupcount" id="thumbupcount">{{(int)$thumbupCount+20000}}</span>人为活动围观点赞</p>
			</div>
		...
		<section class="section partner" id="partner">
			...
			<div class="groups">
				<img data-original="images/roundchina/partner-4@2x.png" alt="" class="special lazy" id="special_tag" width="100%">
