...
<div class="form-group">
    {!! Form::label('votes', '点赞数', ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-3">
        {!! Form::text('votes', isset($route->id) ? $route->votes : 0, ['class' => 'form-control', 'placeholder' => '点赞数']) !!}
    </div>
</div><!--form control-->
...
<div class="form-group">
    ...
    <div class="col-lg-3">
        @if(isset($route->id))
            <input type="checkbox" value="{{$route->getOriginal('active')}}" id="active" name="active" {{$route->getOriginal('active') == 1 ? 'checked' : ''}}/>
        @else
